...
class Server:
    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        '''
        desc: method that computes the data for a given page
            based on passed index. It takes care of updates by
            using the dataset everytime newly
        Args:
            index: start index
            page_size: page size
        Return: a dictionary with the following key-value pairs:
            index: the current start index of the return page.
                ...
                page. For example if requesting page 3 with page_size 20,
